...
export const CategoryItem = ({ category, isSelected, onSelect}: CategoryItemProps) => {
    const selectedStyles = isSelected ? "bg-b-black text-b-white" : "bg-b-white text-b-black border-2 border-b-black";

    const baseStyles = "w-max h-12 flex items-center justify-between gap-2 px-4 py-3 rounded-full cursor-pointer transition-colors duration-300 font-sans font-medium";

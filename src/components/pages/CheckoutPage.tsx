...
export const CheckoutPage = () => {
   return (
      <div className="w-full min-h-screen pt-4 pb-8 md:pt-8 lg:pt-12 xl:pb-24">
         <section className="flex flex-col items-start gap-5">
            <h3 className="font-chillax font-semibold text-lg md:text-2xl">
               Checkout
            </h3>
            <div className="w-full flex flex-col items-start justify-between gap-15.5 lg:flex-row xl:gap-28">
